...
import { buildMarketAnalyzerPrompt } from '@/lib/ai/market-analyzer-prompt';
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const prompt = buildMarketAnalyzerPrompt(payload);
    ...
    const result = analyzerResultSchema.parse(parsed);
